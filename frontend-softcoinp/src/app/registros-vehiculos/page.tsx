      ...
      <div className="max-w-[1700px] mx-auto w-full h-full flex flex-col min-h-0">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 mb-4 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest leading-none mt-1">Registro detallado de ingresos vehiculares</p>
            </div>
          </div>
        ...
        <div className="bg-card rounded-xl border border-border p-4 mb-4 flex-shrink-0 transition-colors">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 items-end">
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-wider px-1">Desde</label>
              <input
                type="date"
                value={desde}
                onChange={(e) => setDesde(e.target.value)}
                className="w-full p-2.5 bg-input border border-border rounded-xl text-xs font-bold focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all text-foreground"
              />
            </div>
            <div className="space-y-1">
              <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-wider px-1">Hasta</label>
              <input
                type="date"
                value={hasta}
                ...
                <table className="min-w-full divide-y divide-border border-separate border-spacing-0">
                  <thead className="bg-background sticky top-0 z-10 shadow-sm">
                    <tr>
                      ...
                      <th className="px-5 py-4 text-left text-[10px] font-black text-slate-500 uppercase tracking-widest border-b border-border">Ingreso</th>
                      <th className="px-5 py-4 text-left text-[10px] font-black text-slate-500 uppercase tracking-widest border-b border-border">Salida</th>
                    </tr>
                  </thead>
                          ...
                          <tr key={r.id} className="hover:bg-cyan-500/5 transition-all group">
                            ...
                            <td className="px-5 py-4 whitespace-nowrap">
                              <div className="flex flex-col">
                                <span className="text-[13px] font-black text-foreground leading-tight">{r.marca}</span>
                                <span className="text-[11px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-tighter">{r.modelo || "S.M"}</span>
                              </div>
                            </td>
                            <td className="px-5 py-4 whitespace-nowrap">
                            ...
                            <td className="px-5 py-4 whitespace-nowrap">
                               {isSalidaPending ? (
                                 ...
                                 <div className="flex flex-col">
                                   ...
                                   <span className="text-[10px] font-bold text-rose-500 dark:text-rose-400 mt-0.5 tracking-widest">{salida.hora}</span>
                                 </div>
                               )}
                            </td>
                          </tr>
