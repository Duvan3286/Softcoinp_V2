          ...
          <div className="flex items-center gap-2">
            <div className="relative min-w-[230px]">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-2 bg-input border border-border rounded-xl text-[13px] font-bold focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-400 outline-none transition-all placeholder-slate-300 dark:placeholder-slate-600 uppercase shadow-sm text-foreground"
              />
            </div>
            <select
              value={statusFilter}
              onChange={e => setStatusFilter(e.target.value as "todos" | "bloqueado" | "habilitado")}
              className="py-2 px-3 bg-input border border-border rounded-xl text-[12px] font-black text-slate-600 dark:text-slate-400 uppercase tracking-wider focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-400 outline-none transition-all shadow-sm cursor-pointer"
            >
           ...
           <div className="overflow-x-auto flex-1 custom-scrollbar">
             {loading ? (
                <div className="flex items-center justify-center h-full min-h-[300px] text-slate-400 gap-3 flex-col">
                   <div className="w-8 h-8 border-4 border-border border-t-indigo-600 rounded-full animate-spin"></div>
                      ...
                      <tr key={p.id} className="hover:bg-indigo-50/30 dark:hover:bg-indigo-900/10 transition-colors group">
                        <td className="p-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                               <p className="uppercase leading-none group-hover:text-indigo-700 dark:group-hover:text-indigo-400 transition-colors">{p.nombre} {p.apellido}</p>
                        ...
                        <td className="p-4">
                           <div className="flex flex-col">
                             <span className="uppercase text-indigo-600 dark:text-indigo-400">{p.tipo}</span>
             ...
             <div className="bg-background relative z-10 border-t border-border p-3 flex items-center justify-between shrink-0 transition-colors">
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-1.5 bg-card border border-border rounded-lg text-slate-400 hover:text-indigo-600 disabled:opacity-30 disabled:hover:text-slate-400 transition-all shadow-sm active:scale-90"
                  >
