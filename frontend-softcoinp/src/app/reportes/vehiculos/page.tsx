...
import { CarFront, Search, FolderOpen, Car, ChevronLeft, ChevronRight } from "lucide-react";
             ...
             {loading ? (
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="text-[13px] font-bold text-foreground divide-y divide-border transition-colors">
                    {currentItems.map(v => (
                      <tr key={v.id} className="hover:bg-emerald-50/30 dark:hover:bg-emerald-900/10 transition-colors group">
                        <td className="p-4">
                          <div className="flex items-center gap-3">
                            {v.fotoUrl ? (
                              <img
                              ...
                              <div className="w-10 h-10 rounded-xl bg-input flex items-center justify-center border-2 border-border shadow-sm"><Car className="w-5 h-5 text-slate-400 dark:text-slate-600" /></div>
                            )}
                            <div>
                               <p className="text-[14px] text-emerald-600 dark:text-emerald-400 uppercase leading-none group-hover:text-emerald-700 dark:group-hover:text-emerald-500 transition-colors tracking-tight font-black">{v.placa}</p>
