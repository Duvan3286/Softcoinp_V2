      ...
      {users.map((user) => (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-sm font-black text-foreground uppercase tracking-tight group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors truncate">
                {user.nombre || "Usuario sin nombre"}
            </h2>
            <div className="flex items-center gap-3 mt-1">
                <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-tight truncate max-w-[150px] lg:max-w-none">
                    {user.email}
                </p>
                <div className="h-1 w-1 bg-slate-300 dark:bg-slate-700 rounded-full hidden sm:block"></div>
                <p className="text-[9px] font-black text-slate-300 dark:text-slate-600 uppercase hidden sm:block">
